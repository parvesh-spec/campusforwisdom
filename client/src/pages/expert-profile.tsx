                      ...
                      <Card className="border hover:shadow-md transition-shadow cursor-pointer">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <h4 className="font-semibold text-lg text-gray-900 mb-1 break-words">{session.title}</h4>
                            <p className="text-gray-600 text-sm mb-3 break-words">{session.description}</p>
